CC = g++ -std=c++0x
INC = /usr/include/python2.7 -lpython2.7
TARGET = totp

doerflea-MP4: totp.c lib/sha1.o lib/encoding.o lib/bitstream.o lib/mask.o lib/mmask.o lib/mqrspec.o lib/qrencode.o lib/qrinput.o lib/qrspec.o lib/rsecc.o lib/split.o
		gcc -I$(INC) totp.c lib/sha1.o lib/encoding.o  lib/bitstream.o lib/mask.o lib/mmask.o lib/mqrspec.o lib/qrencode.o lib/qrinput.o lib/qrspec.o lib/rsecc.o lib/split.o -o doerflea-MP4
